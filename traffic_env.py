...
class TrafficEnvironment:
	...
	def step(self, action: List[int]):
		observation = [0.9, 0.1] # [percent of train under control, percent of other train] ARTUR
		reward = 1 # return time (ticks) from start ARTUR
		done = False # True if accident or more than one_game_max_time ARTUR 
		info = {} # now is empty
