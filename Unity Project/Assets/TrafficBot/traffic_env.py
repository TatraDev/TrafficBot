...
class TrafficEnvironment:
        ...
        def reset(self):
            ...
            # ARTHUR  TO DO SET FIRST OBSERVATION IN THE GAME

        def step(self, action: List[int]):
            observation, reward, done, info = np.random.randn(4), 1 if action > 0.5 else 0, action > 0.95, {}
            # ARTHUR  TO DO CONNECT WITH NETWORK
